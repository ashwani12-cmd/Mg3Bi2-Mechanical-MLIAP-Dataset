...
BND_BIN="/home/IITB/multiscale-mechanics/amit.k.singh/software/builds/qe-7.1/build/bin/bands.x"
...
#time ${MPIRUN_PATH} -np ${SLURM_NTASKS} ${PWX_BIN} <  espresso_bands.pwi >  espresso_bands.pwo
time ${MPIRUN_PATH} -np ${SLURM_NTASKS} ${BND_BIN} <  espresso_pp.bands.pwi > espresso_pp.bands.pwo
